...
def main(cfg):
    ...
    if "hispndit" in cfg.model.name:
        ...
        # ckpt_file = "/home/yishu/flowbothd/logs/train_trajectory_diffuser_hispndit/2024-05-25/02-00-54/checkpoints/epoch=399-step=331600-val_loss=0.00-weights-only.ckpt"
